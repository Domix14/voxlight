...
int main() {
    ...
    engine.worldSystem.createVoxelEntity(voxelData, glm::vec3(0.0f, 0.0f, 0.0f));
    ...
    engine.worldSystem.createVoxelEntity(voxelData, glm::vec3(0.0f, 0.0f, 10.0f));
    ...
    engine.worldSystem.createVoxelEntity(voxelData, glm::vec3(0.0f, 0.0f, 20.0f));
